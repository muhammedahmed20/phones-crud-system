      ...
      <div className="w-full flex flex-col overflow-auto">
        <div className="flex flex-col gap-7 p-2 md:p-6">
          <div className="w-full flex  justify-between items-center">
            <h1 className="text-[16px] md:text-[32px] w-8/12">Our Mobile Collection</h1>
            <div className="container flex md:hidden items-center gap-2 w-4/12">
              <div className="flex justify-center items-center text-[22px] border border-blue-400 text-white w-8 h-8 rounded-full bg-blue-200">
                {letter}
              </div>
              <div className="flex flex-col">
                <p className="capitalize text-[8px] text-blue-400 ">
                  welcome,
                </p>
                <p className="capitalize text-[10px] font-bold ">
                  {name}
                </p>
              </div>
            </div>
                  ...
                  <div className="w-full flex flex-col items-center gap-5">
                    ...
                    <div className="w-full flex justify-between">
                      ...
                      <div className="w-1/3 flex flex-col items-center">
                        ...
                        <h5 className="text-[15px] font-bold text-success">
                          {el.quantity}
                        </h5>
                      </div>
                      <div className="w-1/3 flex flex-col items-center">
                    ...
                    <div className="w-full grid grid-cols-2 gap-3">
                      <button
                        className="btn col-span-1 row-span-1 bg-red-200"
                        onClick={removePhone}
                      >
                        <CiTrash className="text-red-700" />
                      </button>
                      <button
                        className="btn col-span-1 row-span-1 btn-soft btn-warning"
                        onClick={() => {
        ...
        <div className="modal-box">
          ...
          <div className="w-full flex flex-col gap-3">
            <input
              ref={phoneName}
              type="text"
              className="input w-full outline-none focus:border-blue-200"
              placeholder="Enter the new phone name"
            />
            <input
              ref={phonePrice}
              type="text"
              className="input w-full outline-none focus:border-blue-200"
              placeholder="Enter the new phone price"
            />
            <input
              ref={phoneQty}
              type="text"
              className="input w-full outline-none focus:border-blue-200"
              placeholder="Enter the new phone qty"
            />
            <button
              className="w-full btn bg-success text-white"
              onClick={addNewPhone}
            >
              Add New
            </button>
        ...
        <div className="modal-box">
          ...
          <div className="w-full flex flex-col gap-3">
            ...
            <input
              ...
              type="text"
              className="input w-full outline-none focus:border-blue-200"
              placeholder="Enter the new qty"
            />
            <button
              className="w-full btn bg-info text-white"
              onClick={saveEdit}
            >
              update
            </button>
